  ...
  return (
    <div className="absolute top-[15%] md:top-1/4  w-full text-center mx-auto">
      ...
      <p className="text-xs  mt-3">| Give you full of love from zoa |</p>
        ...
        <button className="text-sm md:text-xl font-semibold py-1 px-3 md:py-2 md:px-8 bg-[#6bb42f] mt-5 border border-[#6bb42f] hover:bg-white hover:text-[#6bb42f] ">Show All Products</button>
      </div>
