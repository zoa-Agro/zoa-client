  ...
  return (
    <div className="drawer lg:drawer-open">
      ...
      <div className="drawer-content flex flex-col items-center justify-center">
        ...
        <label
          htmlFor="my-drawer-2"
          className="btn btn-neutral w-full drawer-button lg:hidden"
        >
            ...
            <ul>
              ...
              {isAdmin ? (
                <>
                  ...
                  <li>
                  <NavLink to="/dashboard/allordered-products">
                      <GiConfirmed /> Ordered Products
                    </NavLink>
                  </li>
                </>
              ) : isSeller ? (
                <>
                  ...
                  {/* <li>
                    <NavLink to="/dashboard/order-products">
                      <GiConfirmed /> Ordered Products
                    </NavLink>
                  </li> */}
                </>
                ...
                <>
                  ...
                  <li>
                    <NavLink to="/dashboard/ordered-products">
                      <GiConfirmed /> Ordered Products
                    </NavLink>
                  </li>
                  <li>
